...
class SubscribersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscriber" do
    assert_difference("Subscriber.count") do
      post subscribers_url, params: { subscriber: { category: @subscriber.category, first_name: @subscriber.first_name, last_name: @subscriber.last_name, user_id: @subscriber.user_id } }
    end
  ...
  test "should update subscriber" do
    patch subscriber_url(@subscriber), params: { subscriber: { category: @subscriber.category, first_name: @subscriber.first_name, last_name: @subscriber.last_name, user_id: @subscriber.user_id } }
